        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="card p-4 rounded shadow form-bg">
                    <h2 class="text-center mb-4">Восстановление аккаунта</h2>
                    ...
                    <form action="" method="POST" class="was-validated">              
                        ...
                        <button type="submit" class="btn btn-primary btn-block mt-4">Восстановить</button>
                    </form>
                    <p class="form-footer">Вспомнили пароль?<span><a href="/login">Войти</a></span></p> 
                </div>
            </div>
        </div>
    </div>
